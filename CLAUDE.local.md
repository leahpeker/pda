...
**YOU ARE IN: `pda/polecats/rust/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/pda/` (rig root) or other directories
...
**Your mail address:** `pda/polecats/rust`
**Your rig:** pda
**Your Witness:** `pda/witness`
...
| Ask Witness for help | `gt mail send pda/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`pda/witness`) when:
...
```bash
gt mail send pda/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
